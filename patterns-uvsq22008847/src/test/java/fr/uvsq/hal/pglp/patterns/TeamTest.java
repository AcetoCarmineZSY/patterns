...
class TeamTest {
  ...
  public void unGroupePeutEtreParcourus() {
    final List<Element> expectedEmployees = List.of(frodon, gandalf);
    List<Element> visitedEmployees = new ArrayList<>();
    for (Element element : communaute) {
  ...
  public void unAutreGroupeImbriquePeutEtreParcourus() {
    final List<Element> expectedEmployees = List.of(frodon, gandalf, frodon, gandalf, frodon, gandalf, gandalf, frodon, gandalf, frodon);
    List<Element> visitedEmployees = new ArrayList<>();
    Team team1 = new Team();
    team1.add(frodon);
    Team team2 = new Team();
